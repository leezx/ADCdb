---
id: "ANI0FTPEV"
name: "Anti-PSMA mAb wt HC S41C"
entity_type: "Antibodie"
source_url: "https://adcdb.idrblab.net/data/antibody/details/ANI0FTPEV"
---

# Anti-PSMA mAb wt HC S41C

Source: https://adcdb.idrblab.net/data/antibody/details/ANI0FTPEV

## ADCdb Links

- [Antigen Info](https://adcdb.idrblab.net/data/abt/details/TAR0ZHRFU)
- [ADC Info](https://adcdb.idrblab.net/data/adc/details/DRG0AVEQT)
- [ADC Info](https://adcdb.idrblab.net/data/adc/details/DRG0ASXDK)

## General Information

| Field            | Value                                |
| ---------------- | ------------------------------------ |
| Antibody ID      | ANI0FTPEV                            |
...
- **Tumor Growth Inhibition value (TGI):** ≈ 93.44% (Day 69) Positive PSMA expression ( PSMA+++/++ )
- **Method Description:** Tumours were induced subcutaneously by injecting of 10,000,000 LnCap C4.2 cells in 200 uL of RPMI 1640 containing matrigel into the right flank of male CB17.SCID mice. Treatments were started when the tumors reached a mean volume of 100-200 mm 3 . Mice were randomized according to their individual tumor volume into groups and received a single i.v, 10 mg/kg inection of anti-PSMA ADC.
- **In Vivo Model:** LNCaP C4-2 CDX model
- **In Vitro Model:** Lymph node metastasis of prostate carcinoma LNCaP C4-2 cells CVCL_4782 Revealed Based on the Cell Line Data
**Experiment 1 Reporting the Activity Date of This ADC**

- **Efficacy Data:** Max inhibition rate (MIR) 59.00% Negative PSMA expression ( PSMA- )
...
- **Efficacy Data:** Max inhibition rate (MIR) 78.00% Positive PSMA expression ( PSMA+++/++ )
...
- **Efficacy Data:** Half Maximal Inhibitory Concentration (IC50) 0.25 nM Positive PSMA expression ( PSMA+++/++ )
- **Method Description:** LNCaP C4-2 cells were incubated with increasing concentrations of each ADCs at 37°C for 6 days in complete culture medium.
- **In Vitro Model:** Lymph node metastasis of prostate carcinoma LNCaP C4-2 cells CVCL_4782
