...
**Methodology**: For PMIDs identified in Layer 3 as later-published around each seed, apply `ADC_QUERY_TERM` (`"antibody-drug conjugate" OR "antibody drug conjugate" OR "vedotin" OR "deruxtecan" OR "govitecan" OR "mafodotin" OR "tesirine" OR "emtansine" OR "ozogamicin" OR "tirumotecan"[tiab]`) and compute recall.
...
| Later-Pub Recall | [from PR #3] | 100% (sample) |
